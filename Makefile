...
OPT1 = --crf 22 -b2 -m3 -r3 --me hex --no-8x8dct --direct spatial --no-dct-decimate -t0  --slice-max-mbs 50
...
OPT4 = --crf 22 -b3 -m7 -r4 --me esa -t2 -A all --psy-rd 1.0:1.0 --slices 4 --b-pyramid strict --open-gop --bluray-compat --fade-compensate 0.5 --aq-mode 3
