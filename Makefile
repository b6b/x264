...
SRCCLI = x264.c autocomplete.c input/input.c input/timecode.c input/raw.c input/y4m.c \
...
<<<<<<< HEAD
OPT4 = --crf 22 -b3 -m7 -r4 --me esa -t2 -A all --psy-rd 1.0:1.0 --slices 4 --b-pyramid strict --fade-compensate 0.5
=======
OPT4 = --crf 22 -b3 -m7 -r4 --me esa -t2 -A all --psy-rd 1.0:1.0 --slices 4 --b-pyramid strict --open-gop --bluray-compat --fgo 8 --fade-compensate 0.5
>>>>>>> Add open-gop and bluray-compat to fprofiled.
